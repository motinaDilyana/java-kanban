...
public class FileBackendTaskManager extends InMemoryTaskManager {
    ...
    private static void fromString(String value) {
        ...
        if (Objects.equals(Type.EPIC.toString(), params[1])) {
            new Epic(parseInt(params[0]), params[2], params[4], params[3].toUpperCase());
        } else if (Objects.equals(Type.SUBTASK.toString(), params[1])) {
            new SubTask(parseInt(params[0]), params[2], params[4], params[3].toUpperCase(), parseInt(params[5]));
        } else {
            new Task(parseInt(params[0]), params[2], params[4], params[3].toUpperCase());
        }
    }
